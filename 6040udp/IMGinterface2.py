...
def edge(f_clip):
    ...
    edges_c = cv2.Canny(f_gray,10, 250, apertureSize=5, L2gradient = False)
    cv2.imshow('canny', cv2.resize(edges_c, (360, 240)))
...
def threshold(f_clip):
    ...
    #ret, solid_f = cv2.threshold(f_gray,4,255,cv2.THRESH_OTSU) 
